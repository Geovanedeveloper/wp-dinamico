	...
	<!-- do stuff ... -->
				<article class="mu-blog-item">
											...
											<div class="mu-blog-item-content">
												...
												<h1 class="mu-blog-item-title"><?php the_title(); ?></h1>
						                          ...
						                          <li>
						                            <div class="media">
						                              <div class="media-left">    
						                                <img alt="img" src="<?php bloginfo ('template_directory'); ?>/assets/images/client.png" class="media-object news-img">
						                              </div>
									...
									<div class="mu-blog-sidebar">
										...
										<div class="mu-sidebar-widget">
											...
											<div class="mu-popular-content-widget">
												<div class="media">
												  <a href="#" class="mu-popular-post-img"><img src="<?php bloginfo ('template_directory'); ?>/assets/images/blog-img-1.jpg" alt="image"></a>
												  <div class="media-body">
												    <ul class="mu-blog-meta">
														<li>08 Nov 2017 </li>
														<li><a href="#"><i class="fa fa-comment-o"></i>26</a></li>
												...
												<div class="media">
												  <a href="#" class="mu-popular-post-img"><img src="<?php bloginfo ('template_directory'); ?>/assets/images/blog-img-2.jpg" alt="image"></a>
												  <div class="media-body">
												    <ul class="mu-blog-meta">
														<li>08 Nov 2017 </li>
														<li><a href="#"><i class="fa fa-comment-o"></i>26</a></li>
												...
												<div class="media">
												  <a href="#" class="mu-popular-post-img"><img src="<?php bloginfo ('template_directory'); ?>/assets/images/blog-img-3.jpg" alt="image"></a>
												  <div class="media-body">
												    <ul class="mu-blog-meta">
														<li>08 Nov 2017 </li>
														<li><a href="#"><i class="fa fa-comment-o"></i>26</a></li>
