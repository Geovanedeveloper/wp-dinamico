	...
	<div id="mu-slider">
		<div class="mu-slide">
			...
			<div class="mu-single-slide">
				<img src="<?php bloginfo('template_directory'); ?>/assets/images/slider-img-1.jpg" alt="slider img">
			...
			<!-- Start single slide  -->
			<div class="mu-single-slide">
				<img src="<?php bloginfo('template_directory'); ?>/assets/images/slider-img-2.jpg" alt="slider img">
				<div class="mu-single-slide-content-area">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
			...
			<!-- Start single slide  -->
			<div class="mu-single-slide">
				<img src="<?php bloginfo('template_directory'); ?>/assets/images/slider-img-3.jpg" alt="slider img">
				<div class="mu-single-slide-content-area">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mu-about-left">
										<img class="" src="<?php bloginfo('template_directory'); ?>/assets/images/about-us.jpg" alt="img">
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="mu-portfolio-content">
										<div class="filtr-container">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="4">
							                   <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-1.jpg" title="PAINTING">
								                   	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-1.jpg" alt="image">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="5">
							                    <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-2.jpg" title="BRANDING">
							                    	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-2.jpg" alt="image">
								                    <div class="mu-filter-item-content">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="3">
							                    <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-3.jpg" title="E-COMMERCE">
							                    	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-3.jpg" alt="image">
								                    <div class="mu-filter-item-content">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="1">
							                    <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-4.jpg" title="WEB DESIGN">
							                    	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-4.jpg" alt="image">
								                    <div class="mu-filter-item-content">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="2">
							                    <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-5.jpg" title="MOBILE DEVELOPMENT">
							                    	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-5.jpg" alt="image">
								                    <div class="mu-filter-item-content">
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="5">
							                   <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-6.jpg" title="BRANDING">
								                   	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-6.jpg" alt="image">
								                    <div class="mu-filter-item-content">
								                    	<h4 class="mu-filter-item-title">BRANDING</h4>
								                    	<span class="fa fa-long-arrow-right"></span>
								                    </div>
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="3">
							                   <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-7.jpg" title="E-COMMERCE">
								                   	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-7.jpg" alt="image">
								                    <div class="mu-filter-item-content">
								                    	<h4 class="mu-filter-item-title">E-COMMERCE</h4>
								                    	<span class="fa fa-long-arrow-right"></span>
								                    </div>
							                ...
							                <div class="col-xs-6 col-sm-6 col-md-4 filtr-item" data-category="4">
							                    <a class="mu-imglink" href="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-8.jpg" title="PAINTING">
							                    	<img class="img-responsive" src="<?php bloginfo('template_directory'); ?>/assets/images/portfolio/img-8.jpg" alt="image">
								                    <div class="mu-filter-item-content">
								                    	<h4 class="mu-filter-item-title">PAINTING</h4>
								                    	<span class="fa fa-long-arrow-right"></span>
								                    </div>
						...
						<div class="mu-testimonials-area">
							...
							<div class="mu-testimonials-block">
								<ul class="mu-testimonial-slide">
									...
									<li>
										<img class="mu-rt-img" src="<?php bloginfo('template_directory'); ?>/assets/images/traveler-1.jpg" alt="img">
									...
									<li>
										<img class="mu-rt-img" src="<?php bloginfo('template_directory'); ?>/assets/images/traveler-2.jpg" alt="img">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa</p>
									...
									<li>
										<img class="mu-rt-img" src="<?php bloginfo('template_directory'); ?>/assets/images/traveler-3.jpg" alt="img">
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa</p>
										...
										<div class="row">
											<div class="col-md-4">
												<article class="mu-blog-item">
													<a href="#"><img src="<?php bloginfo('template_directory'); ?>/assets/images/blog-img-1.jpg" alt="blgo image"></a>
											...
											<div class="col-md-4">
												<article class="mu-blog-item">
													<a href="#"><img src="<?php bloginfo('template_directory'); ?>/assets/images/blog-img-2.jpg" alt="blgo image"></a>
													<div class="mu-blog-item-content">
														<ul class="mu-blog-meta">
															<li>BY: ADMIN </li>
															<li><a href="#"><i class="fa fa-comment-o"></i>26</a></li>
											...
											<div class="col-md-4">
												<article class="mu-blog-item">
													<a href="#"><img src="<?php bloginfo('template_directory'); ?>/assets/images/blog-img-3.jpg" alt="blgo image"></a>
													<div class="mu-blog-item-content">
														<ul class="mu-blog-meta">
															<li>BY: ADMIN </li>
															<li><a href="#"><i class="fa fa-comment-o"></i>26</a></li>
						...
						<div class="mu-clients-area">
							...
							<div class="mu-clients-slider">
								...
								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-1.jpg" alt="Brand Logo">
								</div>

								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-2.jpg" alt="Brand Logo">
								</div>

								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-3.jpg" alt="Brand Logo">
								</div>

								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-4.jpg" alt="Brand Logo">
								</div>

								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-5.jpg" alt="Brand Logo">
								</div>

								<div class="mu-clients-single">
									<img src="<?php bloginfo('template_directory'); ?>/assets/images/client-brand-6.jpg" alt="Brand Logo">
								</div>
							</div>
